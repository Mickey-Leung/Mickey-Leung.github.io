...
Ph.D. Candidate • Researcher • Engineer
...
## Skills
**Fluid Dynamics & Modeling:** AI for fluids, LES, turbulence/SGS modeling, reduced-order modeling, aero/hydrodynamics, 3D meshing<br>
**Control & ML:** reinforcement learning (DRL), neural networks, optimal sensor placement, attribution methods, sparse regression<br>
**Scientific Computing:** Python, MATLAB, Fortran, C/C++; data processing & visualization<br>
**HPC & Workflow:** Linux, job schedulers (Slurm/PBS basics), parallel programming<br>
**CAD modeling & drawings:** ProE/Creo, SolidWorks, Fusion 360<br>
...
- [Learned constitutive models for non-Newtonian fluids](/project-rheology) — Neural-network constitutive models trained on simulated non-viscometric flows.
- [Elastocapillary morphing (single/multi-fin)](/project_elastocap) — Experiments and models of capillarity-driven shape change.
